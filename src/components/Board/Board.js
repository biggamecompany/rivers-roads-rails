...
// import TilePatterns from "../../constants/tilePatterns.json";
...
class Board extends React.Component {
	...
	loadNewTile() {
		...
		// let boardCache = [...this.state.boardCache];
		let tempBoard = JSON.parse(JSON.stringify(this.state.boardCache));
		// // 2. Make a shallow copy of the item you want to mutate
		// let item = { ...boardCache[2][2].options };
		// // 3. Replace the property you're interested in
		tempBoard[2][2].options = this.state.currentTile;
		// // 4. Put it back into our array. N.B. we *are* mutating the array here, but that's why we made a copy first
		// boardCache[2][2].options = item;
